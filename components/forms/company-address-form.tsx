...
const createFormSchema = z.object({
  ...
  type: z.enum(
    [AddressType.COMPANY, AddressType.BILLING, AddressType.SHIPPING],
    {
...
const updateFormSchema = z.object({
  ...
  type: z
    .enum([AddressType.COMPANY, AddressType.BILLING, AddressType.SHIPPING], {
      required_error: 'Type is required'
    })
    .optional(),
  is_default: z.boolean().optional()
...
export const CompanyAddressForm: React.FC<UserFormProps> = ({
  initialData
}) => {
  ...
  const onSubmit = async (data: UserFormValues) => {
    try {
      ...
      router.refresh();
      router.push(`/dashboard/address/company`);
      toast({
        variant: 'default',
        title: toastMessage,
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value={AddressType.COMPANY}>
                            Company
                          </SelectItem>
